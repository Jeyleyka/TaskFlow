...
IndexWndWidget::IndexWndWidget(QWidget* parent)
    : QWidget(parent)
{
    // Основной layout
    ...
    connect(this->navBar, &NavigationBar::switchToCalendar, this, &IndexWndWidget::switchToCalendar);
...
void IndexWndWidget::initDatabase() {
    this->dataBase = new DatabaseManager;
    this->dataBase->initializeDatabase();
}

void IndexWndWidget::initSearch() {
    ...
    connect(this->search, &QLineEdit::textChanged, this, &IndexWndWidget::searchTaskFilter);
}

void IndexWndWidget::initSortTags() {
...
void IndexWndWidget::onDeleteTask(const int row) {
...
void IndexWndWidget::showTaskDialog() {
...
void IndexWndWidget::searchTaskFilter(const QString &title) {
