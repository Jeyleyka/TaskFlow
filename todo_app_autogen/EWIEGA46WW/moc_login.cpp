...
template <> constexpr inline auto Login::qt_create_metaobjectdata<qt_meta_tag_ZN5LoginE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'CheckDataToCorrectly'
        QtMocHelpers::SlotData<bool(const QString &, const QString &)>(1, 2, QMC::AccessPrivate, QMetaType::Bool, {{
...
void Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: { bool _r = _t->CheckDataToCorrectly((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])));
