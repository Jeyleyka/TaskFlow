...
CategoryEditor::CategoryEditor(QWidget* parent)
    ...
    this->nameEdit->setPlaceholderText("Category name");
    ...
    this->iconCombo->addItem(QIcon(":/icons/briefcase.png"), "briefcase");
    this->iconCombo->addItem(QIcon(":/icons/dumbbell.png"), "dumbbell");
    this->iconCombo->addItem(QIcon(":/icons/healthcare.png"), "healthcare");
    this->iconCombo->addItem(QIcon(":/icons/home.png"), "home");
    this->iconCombo->addItem(QIcon(":/icons/megaphone.png"), "megaphone");
    this->iconCombo->addItem(QIcon(":/icons/music.png"), "music");
    this->iconCombo->addItem(QIcon(":/icons/ux-design.png"), "ux-design");
    this->iconCombo->addItem(QIcon(":/icons/video-camera.png"), "video-camera");
    this->iconCombo->addItem(QIcon(":/icons/graduation-cap.png"), "graducation-cap");
    this->iconCombo->addItem(QIcon(":/icons/plus.png"), "plus");
    ...
    this->createCategory = new QPushButton("Create Category", this);
